...
import { FaStar, FaUser, FaTwitter, FaWhatsapp, FaInstagram, FaFacebook, FaHeart } from 'react-icons/fa';
...
const Stores: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-200 flex flex-col">
      ...
      <div className="bg-gray-300 py-16 text-center text-white mx-4 lg:mx-32 mt-10">
        <div className="container mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold mb-2">
            <span className="text-yellow-500">Mark8</span>
            <span className="text-white"> Stores</span>
          </h1>
          <p className="text-lg md:text-xl mb-4">932 Products</p>

          <div className="relative flex justify-center mt-4">
            <input
              type="text"
              placeholder="What are you looking for?"
              className="w-full max-w-sm md:max-w-md lg:max-w-lg pl-10 pr-10 py-2 border border-gray-600 rounded-full bg-gray-300 text-gray-400 placeholder-gray-500"
            />
          </div>

          <div className="flex justify-center mt-6 space-x-2">
            {['All', 'Vectors', 'Icons', 'Backgrounds'].map((category) => (
              <button key={category} className="px-3 py-2 bg-gray-300 text-gray-700 border border-gray-600 rounded-full transition">
                {category}
              </button>
            ))}
          </div>
      ...
      <main className="container mx-auto px-4 py-6 flex-grow">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl md:text-2xl font-semibold text-gray-800">Stores</h2>
        </div>

        {[1, 2].map((shop) => (
          <div key={shop} className="bg-white p-4 md:p-6 rounded-lg shadow mb-6">
            <div className="flex flex-col md:flex-row items-center justify-between mb-4">
              <div className="flex items-center">
                <div className="w-16 h-16 md:w-20 md:h-20 bg-yellow-300 rounded-full mr-4"></div>
                <div>
                  <h3 className="text-lg md:text-xl font-semibold text-gray-800">Awesome Shop {shop}</h3>
                  <p className="text-gray-600">94 Products</p>
                </div>
              </div>
              <button className="bg-yellow-500 text-black px-4 py-2 mt-4 md:mt-0 rounded-md flex items-center space-x-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {[1, 2].map((product) => (
                  <Link key={product} href={`/detail`}>
                    <div className="bg-white p-4 rounded-lg shadow cursor-pointer w-full md:w-auto flex flex-col">
                      ...
                      <div className="flex justify-between mt-auto">
                        <button className="p-2 hover:bg-gray-200"></button>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between md:space-x-4 mt-6">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="p-2 border border-gray-300 rounded w-full md:w-auto mb-4 md:mb-0"
          />
      ...
      <footer className="bg-gray-300 text-black py-4">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="text-center mt-4 md:mt-0">Mark8 ©2024. By Awesomity Ltd</p>
