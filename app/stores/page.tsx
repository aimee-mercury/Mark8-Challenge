...
const Stores: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-200 flex flex-col">
      ...
      <div className="bg-gray-300 py-16 text-center text-white mx-4 sm:mx-32 mt-10">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                {[1, 2].map((product) => (
                  <Link key={product} href={`/detail`}>
                    <div className="bg-white p-4 rounded-lg shadow cursor-pointer flex flex-col">
                      ...
                      <div className="flex justify-between mt-auto">
                        <button className="p-2 hover:bg-gray-200">
                          {/* Cart button (example, you can add your cart functionality here) */}
                        </button>
