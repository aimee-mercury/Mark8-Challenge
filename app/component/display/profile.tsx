...
const Profile: React.FC<ProfilePanelProps> = ({ onClose }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-end z-50">
      <div className="w-full sm:w-80 bg-white h-auto p-4 sm:p-6 overflow-y-auto mt-16 mb-16 sm:mt-20 sm:mb-20">
        ...
        <div className="mb-6">
          <div className="flex items-center mb-4">
            ...
            <div className="ml-4">
              ...
              <p className="text-gray-600 text-sm">marie@gmail.com</p>
            </div>
          </div>
          <hr className="mb-4" />
